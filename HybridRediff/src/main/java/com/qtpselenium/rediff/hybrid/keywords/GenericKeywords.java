...
public class GenericKeywords {
	...
	public void takeSceenShotForFail(){
	...
	public void takeSceenShotForPass() {
		// fileName of the screenshot
				Date d=new Date();
				String screenshotFile=d.toString().replace(":", "_").replace(" ", "_")+".png";
				// take screenshot
				...
				try {
					...
					FileUtils.copyFile(srcFile, new File(ExtentManager.screenshotFolderPath+screenshotFile));
					//put screenshot file in reports
					test.log(Status.PASS,"Screenshot-> "+ test.addScreenCaptureFromPath(ExtentManager.screenshotFolderPath+screenshotFile));
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	...
	public void jsClick(String objectKey)
	{
		if(isElementPresent(objectKey))
		{
		...
		js.executeScript("arguments[0].click();",element);
			...
			reportFailure(objectKey+" Element is not present");
		}
	}
	public void fromMultiLinkBox(String objectKey)
	{
